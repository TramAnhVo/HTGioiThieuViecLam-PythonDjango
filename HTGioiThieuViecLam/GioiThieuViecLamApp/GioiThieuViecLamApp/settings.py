"""
Django settings for GioiThieuViecLamApp project.
...
SECRET_KEY = 'django-insecure-_w^34lqktp-kx$=@*-658sm_c5@smino#q)-==-#%8k^7v%^(8'
...
INSTALLED_APPS = [
    ...
    'GioiThieuViecLam.apps.GioithieuvieclamConfig',
    'ckeditor',
    'ckeditor_uploader',
    'rest_framework',
    'drf_yasg',
...
AUTH_USER_MODEL = 'GioiThieuViecLam.User'
...
ROOT_URLCONF = 'GioiThieuViecLamApp.urls'
...
WSGI_APPLICATION = 'GioiThieuViecLamApp.wsgi.application'
